...
const insertarRegistro = async (pkUsuarioCandidato, tipoCoincidencia) => {
    ...
    try {
        ...
        if (banderaColisiones == 1) {
            ...
            const response = await axios.post(`https://201.124.162.192:3001/api/emparejamiento/insertarRegistros?usuarioPrincipalPK=${userPk}&tipoCoincidencia=${tipoCoincidencia}&usuarioCandidatoPK=${pkUsuarioCandidato}`);
...
const verificarColision = async (pkUsuarioCandidato, tipoCoincidencia) => {
    try {let banderaColisiones = 0;
            ...
            const response = await axios.post(`https://201.124.162.192:3001/api/emparejamiento/verificarColision?pkUsuarioCandidato=${pkUsuarioCandidato}&tipoCoincidencia=${tipoCoincidencia}`);
    ...
    const obtenerStrikes = async () => {
        try {
            const response = await axios.get(`https://201.124.162.192:3001/api/emparejamiento/obtenerStrikes?userPk=${userPk}`);
    ...
    const Rechazos = async () => {
        try {
            const response = await axios.get(`https://201.124.162.192:3001/api/emparejamiento/obtenerRechazos?userPk=${userPk}`);
...
//FUNCION PARA ACTUALIZAR EL NUMERO DE RECHAZOS EN EL CAMPO DE TEXTO
    const actualizarRechazos = async () => {
        try {
            ...
            if (numRechazos <= 0) {
                ...
                const response = await axios.post(`https://201.124.162.192:3001/api/emparejamiento/actualizarRechazos?numrechazos=${numRechazos}&userPk=${userPk}`);
    ...
    const obtenerAlumnosEmparejamiento = async () => {
        try{
            const response = await axios.post(`https://201.124.162.192:3001/api/algoritmo/obtenerUsuarioPrincipal?pkUsuarioPrincipal=${userPk}&banderaRol=${bandera}`);
    ...
    const actualizarEmparejamientosDisponibles = async () => {
        try{
            const response = await axios.post(`https://201.124.162.192:3001/api/emparejamiento/actualizarEmparejamientosDisponibles?userPk=${userPk}`);
